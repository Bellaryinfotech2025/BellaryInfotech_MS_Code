...
public class AlignmentCubicMeterPreFabricatedProductionDTO {
    ...
    private String raNo;
    private List<EntryRowDTO> entries;

    // Constructors
    public AlignmentCubicMeterPreFabricatedProductionDTO() {}

    public AlignmentCubicMeterPreFabricatedProductionDTO(String workOrder, Long orderId, String clientName, 
                                                        String serviceDescription, String uom, String department, 
                                                        String workLocation, String vehicleNumber, String loadNumber, 
                                                        String plotNumber, String raNo, List<EntryRowDTO> entries) {
    ...
    public List<EntryRowDTO> getEntries() { return entries; }
    public void setEntries(List<EntryRowDTO> entries) { this.entries = entries; }

    // Inner class for entry rows
    public static class EntryRowDTO {
        ...
        public EntryRowDTO(String drawingNo, String markNo, Double eachMarkLength, 
