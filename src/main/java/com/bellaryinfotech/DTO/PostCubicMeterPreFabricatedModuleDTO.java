...
public class PostCubicMeterPreFabricatedModuleDTO {
    ...
    private String raNo;
    private List<PostCubicMeterPreFabricatedEntryRowDTO> entries;

    // Constructors
    public PostCubicMeterPreFabricatedModuleDTO() {}

    public PostCubicMeterPreFabricatedModuleDTO(String workOrder, Long orderId, String clientName, 
                                               String serviceDescription, String uom, String department, 
                                               String workLocation, String vehicleNumber, String loadNumber, 
                                               String plotNumber, String raNo, List<PostCubicMeterPreFabricatedEntryRowDTO> entries) {
    ...
    public List<PostCubicMeterPreFabricatedEntryRowDTO> getEntries() { return entries; }
    public void setEntries(List<PostCubicMeterPreFabricatedEntryRowDTO> entries) { this.entries = entries; }

    // Inner class for entry rows
    public static class PostCubicMeterPreFabricatedEntryRowDTO {
        ...
        // Constructors
        public PostCubicMeterPreFabricatedEntryRowDTO() {}

        public PostCubicMeterPreFabricatedEntryRowDTO(String drawingNo, String markNo, Double eachMarkLength, 
