...
public class MeterPreFabricatedDrawingEntryDTO {
    ...
    private List<MeterPreFabricatedEntryRowDTO> entries;
    
    // Constructors
    public MeterPreFabricatedDrawingEntryDTO() {}
    
    public MeterPreFabricatedDrawingEntryDTO(String workOrder, Long orderId, String clientName, 
                                           String serviceDescription, String uom, String department, 
                                           String workLocation, String vehicleNumber, String loadNumber, 
                                           String plotNumber, List<MeterPreFabricatedEntryRowDTO> entries) {
    ...
    public List<MeterPreFabricatedEntryRowDTO> getEntries() { return entries; }
    public void setEntries(List<MeterPreFabricatedEntryRowDTO> entries) { this.entries = entries; }
    
    // Inner class for entry rows
    public static class MeterPreFabricatedEntryRowDTO {
        ...
        // Constructors
        public MeterPreFabricatedEntryRowDTO() {}
        
        public MeterPreFabricatedEntryRowDTO(String drawingNo, String markNo, Double eachMarkLength, 
