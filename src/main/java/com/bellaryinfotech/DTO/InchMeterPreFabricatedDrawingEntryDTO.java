...
public class InchMeterPreFabricatedDrawingEntryDTO {
    ...
    private List<InchMeterPreFabricatedEntryRowDTO> entries;
    
    // Constructors
    public InchMeterPreFabricatedDrawingEntryDTO() {}
    
    public InchMeterPreFabricatedDrawingEntryDTO(String workOrder, Long orderId, String clientName, 
                                               String serviceDescription, String uom, String department, 
                                               String workLocation, String vehicleNumber, String loadNumber, 
                                               String plotNumber, List<InchMeterPreFabricatedEntryRowDTO> entries) {
    ...
    public List<InchMeterPreFabricatedEntryRowDTO> getEntries() { return entries; }
    public void setEntries(List<InchMeterPreFabricatedEntryRowDTO> entries) { this.entries = entries; }
    
    // Inner class for entry rows
    public static class InchMeterPreFabricatedEntryRowDTO {
        ...
        // Constructors
        public InchMeterPreFabricatedEntryRowDTO() {}
        
        public InchMeterPreFabricatedEntryRowDTO(String drawingNo, String markNo, Double eachMarkLength, 
