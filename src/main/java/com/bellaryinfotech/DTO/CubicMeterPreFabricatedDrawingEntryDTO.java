...
public class CubicMeterPreFabricatedDrawingEntryDTO {
    ...
    private List<CubicMeterEntryRowDTO> entries;
    
    // Constructors
    public CubicMeterPreFabricatedDrawingEntryDTO() {}
    ...
    public List<CubicMeterEntryRowDTO> getEntries() { return entries; }
    public void setEntries(List<CubicMeterEntryRowDTO> entries) { this.entries = entries; }
    
    // Inner class for entry rows
    public static class CubicMeterEntryRowDTO {
