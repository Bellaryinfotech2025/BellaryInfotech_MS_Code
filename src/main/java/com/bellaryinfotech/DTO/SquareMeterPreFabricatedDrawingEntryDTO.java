...
public class SquareMeterPreFabricatedDrawingEntryDTO {
    ...
    private List<SquareMeterEntryRowDTO> entries;
    
    // Constructors
    public SquareMeterPreFabricatedDrawingEntryDTO() {}
    ...
    public List<SquareMeterEntryRowDTO> getEntries() { return entries; }
    public void setEntries(List<SquareMeterEntryRowDTO> entries) { this.entries = entries; }
    
    // Inner class for entry rows
    public static class SquareMeterEntryRowDTO {
