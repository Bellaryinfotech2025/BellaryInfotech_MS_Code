...
@Entity
@Table(name = "post_inch_meter_pre_fabricated_module")
public class PostInchMeterPreFabricatedModule {
    ...
    // Constructors
    public PostInchMeterPreFabricatedModule() {}
    
    public PostInchMeterPreFabricatedModule(String workOrder, Long orderId, String clientName, 
