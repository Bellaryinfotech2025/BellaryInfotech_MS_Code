...
@Entity
@Table(name = "inch_meter_module")
public class InchMeterModule {
    @Id
    ...
    public String getDiaMm() { return diaMm; }
    public void setDiaMm(String diaMm) { this.diaMm = diaMm; }
