...
@Entity
@Table(name = "order_fabrication_alignment")
public class OrderFabricationAlignment {
    @Id
    ...
    // Constructors
    public OrderFabricationAlignment() {}
	...
	public Boolean getIsLatestStored() {
	    return isLatestStored;
	}

	public void setIsLatestStored(Boolean isLatestStored) {
	    this.isLatestStored = isLatestStored;
	}
