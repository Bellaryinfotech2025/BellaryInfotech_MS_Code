...
@Entity
@Table(name = "meter_pre_fabricated_drawing_entry")
public class MeterPreFabricatedDrawingEntry {
    ...
    // Constructors
    public MeterPreFabricatedDrawingEntry() {}
    
    public MeterPreFabricatedDrawingEntry(String workOrder, Long orderId, String clientName, 
