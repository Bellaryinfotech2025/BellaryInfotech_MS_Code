...
public class RawMaterialEntry {
    ...
    public RawMaterialEntry(String workOrder, Long orderId, String section, String sectionCode, String materialCode,
                            ...
                            String receiverName, String remarks, String createdBy) {
        this.workOrder = workOrder;
        this.orderId = orderId;
        this.section = section;
        this.sectionCode = sectionCode; // NEW: Added sectionCode to constructor
        ...
        this.remarks = remarks; // NEW: Added remarks to constructor
