...
public class RawMaterialEntry {
    ...
    private BigDecimal totalReceived;
        ...
        // NEW: Added total_transferred_to_other column (String)
    @Column(name = "total_transferred_to_other")
    private String totalTransferredToOther;

        // NEW: Added receiver_name column (String)
    ...
    public RawMaterialEntry() {}
        ...
        public RawMaterialEntry(String workOrder, Long orderId, String section, String materialCode,
                            ...
                            BigDecimal totalWeight, BigDecimal totalReceived, String totalTransferredToOther, String receiverName, String createdBy) { // NEW: Added totalTransferredToOther, receiverName
        ...
        this.totalTransferredToOther = totalTransferredToOther; // NEW: Set in constructor
        this.receiverName = receiverName; // NEW: Set in constructor
    ...
    public void setTotalReceived(BigDecimal totalReceived) { this.totalReceived = totalReceived; }
        ...
        public String getTotalTransferredToOther() { return totalTransferredToOther; } // NEW: Getter for totalTransferredToOther
    public void setTotalTransferredToOther(String totalTransferredToOther) { this.totalTransferredToOther = totalTransferredToOther; } // NEW: Setter for totalTransferredToOther

        public String getReceiverName() { return receiverName; } // NEW: Getter for receiverName
    public void setReceiverName(String receiverName) { this.receiverName = receiverName; } // NEW: Setter for receiverName
