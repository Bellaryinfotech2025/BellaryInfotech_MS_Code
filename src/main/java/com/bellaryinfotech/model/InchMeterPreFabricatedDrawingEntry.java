...
@Entity
@Table(name = "inch_meter_pre_fabricated_drawing_entry")
public class InchMeterPreFabricatedDrawingEntry {
    ...
    // Constructors
    public InchMeterPreFabricatedDrawingEntry() {}
    
    public InchMeterPreFabricatedDrawingEntry(String workOrder, Long orderId, String clientName, 
