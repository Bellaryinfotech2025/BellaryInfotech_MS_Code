...
@Entity
@Table(name = "post_square_meter_pre_fabricated_module")
public class PostSquareMeterPreFabricatedModule {
    ...
    // Constructors
    public PostSquareMeterPreFabricatedModule() {}

    public PostSquareMeterPreFabricatedModule(String workOrder, Long orderId, String clientName, 
