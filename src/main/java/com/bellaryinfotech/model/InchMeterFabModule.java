...
@Entity
@Table(name = "inch_meter_fab_module")
public class InchMeterFabModule {
    ...
    @Column(name = "dia_mm", precision = 10, scale = 3)
    private BigDecimal diaMm;
    ...
    // Default constructor
    public InchMeterFabModule() {
        this.createdDate = LocalDateTime.now();
        this.lastUpdatedDate = LocalDateTime.now();
    }

    // Constructor with essential fields
    public InchMeterFabModule(String workOrder, String buildingName, String drawingNo, String markNo, String raNo) {
        this();
    ...
    public BigDecimal getDiaMm() {
        return diaMm;
    }

    public void setDiaMm(BigDecimal diaMm) {
        this.diaMm = diaMm;
    }
