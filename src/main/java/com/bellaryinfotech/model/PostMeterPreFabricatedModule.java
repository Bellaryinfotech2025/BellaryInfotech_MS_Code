...
@Entity
@Table(name = "post_meter_pre_fabricated_module")
public class PostMeterPreFabricatedModule {
    ...
    // Constructors
    public PostMeterPreFabricatedModule() {}
    
    public PostMeterPreFabricatedModule(String workOrder, Long orderId, String clientName, 
