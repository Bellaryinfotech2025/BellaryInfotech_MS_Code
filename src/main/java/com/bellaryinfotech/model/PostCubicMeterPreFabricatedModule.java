...
@Entity
@Table(name = "post_cubic_meter_pre_fabricated_module")
public class PostCubicMeterPreFabricatedModule {
    ...
    // Constructors
    public PostCubicMeterPreFabricatedModule() {}

    public PostCubicMeterPreFabricatedModule(String workOrder, Long orderId, String clientName, 
